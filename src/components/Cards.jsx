        ...
        <div className='w-full py-[10rem] px-4 bg-white'>
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-3 gap-8'>
                ...
                <div className='w-full shadow-md flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                    <img className='w-16 mx-auto mt-[-3rem] bg-transparent' src="src\assets\undraw_male_avatar_g98d.svg" alt="" />
                ...
                <div className='w-full shadow-md flex flex-col p-4 my-8 md:my-0 rounded-lg hover:scale-105 duration-300'>
                    <img className='w-16 mx-auto mt-[-3rem] bg-transparent' src="src\assets\undraw_female_avatar_efig.svg" alt="" />
                ...
                {/* right card */}
                <div className='w-full shadow-md flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
                    <img className='w-16 mx-auto mt-[-3rem] bg-transparent ' src="src\assets\undraw_people_re_8spw.svg" alt="" />
